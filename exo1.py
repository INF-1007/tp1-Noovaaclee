...
# TODO: Valider les donnees (matchs >= 0, durees > 0)
    ...
    elif duree_football <= 0 or duree_soccer <= 0 : print("Erreur - donnees invalides.")
    else:
# TODO: Calculer les minutes totales (football, soccer, total)
    ...
    # TODO: Convertir en heures/minutes et afficher exactement 4 lignes
        watch_football = f"{int(total_football/60)}h{(total_football%60):02d}"
        watch_soccer = f"{int(total_soccer/60)}h{(total_soccer%60):02d}"
